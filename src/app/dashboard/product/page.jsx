  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <button
        ...
        className="px-4 py-2 bg-pink-500 text-white rounded-md hover:bg-pink-600 mb-4"
      >
        Add Product
      </button>
          ...
          <div className="bg-white rounded-lg shadow-lg w-full max-w-lg p-6">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <input
                ...
                className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring focus:ring-pink-500"
                required
              />
              <input
                type="text"
